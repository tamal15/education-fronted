                ...
                <Row>
                    <Col md={{ span: 8, offset: 2 }}>
                        <div className="login-form text-center shadow" style={{background:"#182533",borderRadius:"20px"}}>
                            <h2 className='mb-5 text-white'>Add Your Syllabus</h2>
                            <form onSubmit={handleSubmit(onSubmit)}>

                                <input
                                  style={{fontWeight:"500"}}
                                className='w-75 mb-3'  {...register("department", { required: true })} placeholder='Department' /> <br />

                                {/* <input className='w-75 mb-3'  {...register("authorName", { required: true })} placeholder='' /> <br /> */}
...
export default AdminPostSyllbus;